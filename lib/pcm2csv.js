...
const pcm2csv = path => {
  ...
  let csv =
		"Fichier;Nom;Hauteur;Classe;Effort;BandeauVertAPoser;NonCalculé;X;Y;CPFOR"; // .csv heading
      ...
      if (isFirstPole && typeArray.includes(pole[i].Classe[0])) {
				csv += firstPole;
				isFirstPole = false;
			} else if (!isFirstPole && typeArray.includes(pole[i].Classe[0])) {
				csv += nextPole;
			} 
		}
		return csv;
